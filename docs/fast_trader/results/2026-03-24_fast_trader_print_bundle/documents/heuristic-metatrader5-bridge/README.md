...
| `custody/engine.py` | Professional custody (`break-even`, ATR/structural trailing, hard cut, no passive underwater, optional scale-out). |
...
FAST_TRADER_RR_RATIO=2.0
FAST_TRADER_SPREAD_MAX_PIPS=3.0
FAST_TRADER_MAX_SLIPPAGE_POINTS=30
